...
What are the Files consists in it -
...
Commands -
1. Terraform Refresh - Usage : Gets updated state of infrastructure from the provider.
2. Terraform Plan - Usage : Creates execution plan. Determines what actions are necessary to achieve the desired state.
3. Terraform Apply - Usage : Executes the plan.
4. Terraform Destroy - Usage : Destroy the infrastructure sequentially, we dont have to know in which order you need to delete the resources.
